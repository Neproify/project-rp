...
addEventHandler("onClientResourceStart", resourceRoot, function()
	...
	addEventHandler("onClientBrowserCreated", notificationsWindow, function()
		notificationsWindow:getBrowser():loadURL("http://mta/local/notifications.html")
	end)
end)
...
function add(msg, msgType, msgDelay)
	...
	notificationsWindow:getBrowser():executeJavascript("addNotification('"..msg.."','"..msgType.."', "..msgDelay..");")
end
